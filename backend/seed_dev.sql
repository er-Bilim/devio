...
-- Если колонки ещё не добавлены в схему таблицы:
-- ALTER TABLE stages ADD COLUMN IF NOT EXISTS topics TEXT[];
-- ALTER TABLE stages ADD COLUMN IF NOT EXISTS duration_weeks INT DEFAULT 1;
